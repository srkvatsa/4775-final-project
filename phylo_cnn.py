...
def main():
    ...
    train_alignments, train_labels = read_alignment_file('TRAIN.aln')
    valid_alignments, valid_labels = read_alignment_file('VALID.aln')
    test_alignments, test_labels = read_alignment_file('TEST.aln')
